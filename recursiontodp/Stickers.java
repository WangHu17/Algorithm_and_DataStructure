 ...
 * @author wanghu
 * @discrption： 贴纸问题
 * 给定一个字符串str，给定一个字符串类型的数组arr，出现的字符都是小写英文，arr每一个字符串，代表一张贴纸，你可以把单个字符串剪开使用，目的是拼出str来，返回需要至少多少张贴纸可以完成这个任务。
 * 例子：str="babac", arr = {"ba"," c" ,"abcd"}，ba + ba + c = 3 |  abcd + abcd = 2，所以返回2。
